    ...
    items: [
      {
        ...
        icon: (
          ...
          >
            ...
            <path d="M12 17c-2 0-3.5-1.3-3.5-3s1.5-3 3.5-3 3.5 1.3 3.5 3-1.5 3-3.5 3z" />
          </svg>
        ),
      },
    ],
...
const Sidebar = () => {
  ...
  const navItems = allNavItems.filter((group) =>
            ...
            <div style={{ padding: "9px 9px 3px", flexShrink: 0 }}>
              <div
                style={{
                  ...
                  border: "0.5px solid rgba(26,26,24,0.09)",
                  borderRadius: "7px",
                  padding: "6px 10px",
                  cursor: "text",
                }}
              >
                ...
                <span style={{ fontSize: "11px", color: "#c0bfb8" }}>
                  Rechercher...
                </span>
              </div>
            </div>
                ...
                <div style={{ overflow: 'hidden', minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                    ...
                    {localStorage.getItem("user_status") === "APPROVED" && (
                      <span
                        title="Profil vérifié par FirmaTrack"
