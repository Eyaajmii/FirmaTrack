    ...
    },
    {
      ...
      items: [
        { to: '/cheptel', label: 'Cheptel', icon: (
          <svg width="15" height="15" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="5" r="3" stroke="currentColor" strokeWidth="1.3"/><path d="M2 14c0-3.3 2.7-5 6-5s6 1.7 6 5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
        )},
        { to: '/lots', label: 'Lots', icon: (
          <svg width="15" height="15" viewBox="0 0 16 16" fill="none"><rect x="1" y="4" width="14" height="10" rx="1.5" stroke="currentColor" strokeWidth="1.3"/><path d="M5 4V3a3 3 0 016 0v1" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
        )},
      ]
    },
    {
  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '0 1.25rem', marginBottom: '2rem' }}>
        <div style={{ fontSize: '15px', fontWeight: '500', color: '#1a1a18', letterSpacing: '-0.3px' }}>
          FirmaTrack
        </div>
        <div style={{ fontSize: '11px', color: '#b0afa9', marginTop: '2px' }}>Ferme El Baraka</div>
      </div>
      ...
      <nav style={{ flex: 1, padding: '0 0.75rem' }}>
        {navItems.map((group, gi) => (
          <div key={gi} style={{ marginBottom: '1.5rem' }}>
            {group.section && (
              <div style={{
                fontSize: '10px', fontWeight: '500', color: '#c0bfb9',
                textTransform: 'uppercase', letterSpacing: '0.07em',
                padding: '0 0.5rem', marginBottom: '4px'
              }}>
                {group.section}
              </div>
            )}
